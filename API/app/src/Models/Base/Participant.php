...
abstract class Participant implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ApostaAiApi\\Models\\Map\\ParticipantTableMap';
    ...
    /**
     * Initializes internal state of ApostaAiApi\Models\Base\Participant object.
     * @see applyDefaults()
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ParticipantTableMap::COL_NAME] = true;
        }
    ...
    public function setCountryCode($v)
    {
        ...
        if ($this->country_code !== $v) {
            $this->country_code = $v;
            $this->modifiedColumns[ParticipantTableMap::COL_COUNTRY_CODE] = true;
        }
    ...
    /**
     * Sets the value of the [is_winner] column.
    ...
    public function setIsWinner($v)
    {
        ...
        if ($this->is_winner !== $v) {
            $this->is_winner = $v;
            $this->modifiedColumns[ParticipantTableMap::COL_IS_WINNER] = true;
        }
    ...
    public function setGameId($v)
    {
        ...
        if ($this->game_id !== $v) {
            $this->game_id = $v;
            $this->modifiedColumns[ParticipantTableMap::COL_GAME_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ParticipantTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ParticipantTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ParticipantTableMap::translateFieldName('CountryCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->country_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ParticipantTableMap::translateFieldName('IsWinner', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_winner = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ParticipantTableMap::translateFieldName('GameId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = ParticipantTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ApostaAiApi\\Models\\Participant'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->betsScheduledForDeletion !== null) {
                if (!$this->betsScheduledForDeletion->isEmpty()) {
                    \ApostaAiApi\Models\BetQuery::create()
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getIsWinner(),
            $keys[4] => $this->getGameId(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ApostaAiApi\Models\Participant
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setCountryCode($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIsWinner($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setGameId($arr[$keys[4]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ApostaAiApi\Models\Participant The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ParticipantTableMap::COL_NAME)) {
            $criteria->add(ParticipantTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ParticipantTableMap::COL_COUNTRY_CODE)) {
            $criteria->add(ParticipantTableMap::COL_COUNTRY_CODE, $this->country_code);
        }
        if ($this->isColumnModified(ParticipantTableMap::COL_IS_WINNER)) {
            $criteria->add(ParticipantTableMap::COL_IS_WINNER, $this->is_winner);
        }
        if ($this->isColumnModified(ParticipantTableMap::COL_GAME_ID)) {
            $criteria->add(ParticipantTableMap::COL_GAME_ID, $this->game_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ApostaAiApi\Models\Participant (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsWinner($this->getIsWinner());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ApostaAiApi\Models\Participant Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGame(ConnectionInterface $con = null)
    {
        if ($this->aGame === null && ($this->game_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGame->addParticipants($this);
             */
        }
    ...
    public function initBets($overrideExisting = true)
    {
        ...
        $this->collBets = new ObjectCollection();
        $this->collBets->setModel('\ApostaAiApi\Models\Bet');
    }
    ...
    public function setBets(Collection $bets, ConnectionInterface $con = null)
    {
        ...
        $this->betsScheduledForDeletion = clone $betsToDelete;

        foreach ($betsToDelete as $betRemoved) {
            $betRemoved->setParticipant(null);
        }
     ...
     * @return ObjectCollection|ChildBet[] List of ChildBet objects
     */
    public function getBetsJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBetQuery::create(null, $criteria);
