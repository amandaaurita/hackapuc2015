...
abstract class User implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ApostaAiApi\\Models\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of ApostaAiApi\Models\Base\User object.
     * @see applyDefaults()
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserTableMap::translateFieldName('Score', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ApostaAiApi\\Models\\User'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO system_user (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ApostaAiApi\Models\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ApostaAiApi\Models\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ApostaAiApi\Models\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ApostaAiApi\Models\User Clone of current object.
     * @throws PropelException
     */
     ...
     * @return ObjectCollection|ChildBet[] List of ChildBet objects
     */
    public function getBetsJoinParticipant(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildBetQuery::create(null, $criteria);
