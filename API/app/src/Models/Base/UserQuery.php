...
use ApostaAiApi\Models\Map\UserTableMap;
 ...
 *
 * @method     ChildUserQuery leftJoinBet($relationAlias = null) Adds a LEFT JOIN clause to the query using the Bet relation
 * @method     ChildUserQuery rightJoinBet($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Bet relation
 * @method     ChildUserQuery innerJoinBet($relationAlias = null) Adds a INNER JOIN clause to the query using the Bet relation
 *
 * @method     ChildUserQuery joinWithBet($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Bet relation
 *
 * @method     ChildUserQuery leftJoinWithBet() Adds a LEFT JOIN clause and with to the query using the Bet relation
 * @method     ChildUserQuery rightJoinWithBet() Adds a RIGHT JOIN clause and with to the query using the Bet relation
 * @method     ChildUserQuery innerJoinWithBet() Adds a INNER JOIN clause and with to the query using the Bet relation
 *
 * @method     \ApostaAiApi\Models\BetQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ApostaAiApi\Models\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\ApostaAiApi\\Models\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, email, password, score FROM system_user WHERE id = :p0';
        try {
    ...
    public function filterByBet($bet, $comparison = null)
    {
        if ($bet instanceof \ApostaAiApi\Models\Bet) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $bet->getUserId(), $comparison);
